...
programs = [
    'momo_unordered_map_open_1',
    'momo_unordered_map_open_2',
    'momo_unordered_map_open_3',
    'momo_unordered_map_open_4',
    'momo_unordered_map_open_0',
]
...
if len(sys.argv) > 1:
    ...
    benchtypes = (
                  'insert_int', 'find_existing_int', 'find_missing_int', 'delete_int',
                  'iterate_int', 
                  'insert_smallstring', 'find_existing_smallstring', 'find_missing_smallstring', 'delete_smallstring', 
#                  'insert_string', 'find_existing_string', 'find_missing_string', 'delete_string',
                  )
