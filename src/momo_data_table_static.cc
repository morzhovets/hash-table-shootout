...
typedef momo::experimental::DataColumnListStatic<StructInt, momo::MemManagerDefault, momo::experimental::DataSettings<false>> DataColumnsInt;
typedef momo::experimental::DataTable<DataColumnsInt> DataTableInt;
...
typedef momo::experimental::DataColumnListStatic<StructStr, momo::MemManagerDefault, momo::experimental::DataSettings<false>> DataColumnsStr;
typedef momo::experimental::DataTable<DataColumnsStr> DataTableStr;
