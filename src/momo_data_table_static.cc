...
#define SETUP_INT DataTableInt table; auto ind = table.AddUniqueHashIndex(cIntKey)
...
#define SETUP_STR DataTableStr str_table; auto str_ind = str_table.AddUniqueHashIndex(cStrKey)
