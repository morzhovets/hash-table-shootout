...
typedef momo::stdish::unordered_map_open<int64_t, int64_t, std::hash<int64_t>, std::equal_to<int64_t>> hash_t;
typedef momo::stdish::unordered_map_open<std::string, int64_t, std::hash<std::string>, std::equal_to<std::string>> str_hash_t;
