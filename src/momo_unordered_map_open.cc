...
typedef momo::stdish::unordered_map_open<int64_t, int64_t> map_t;
typedef momo::stdish::unordered_map_open<std::string, int64_t> str_map_t;

#define SETUP_INT map_t map
#define RESERVE_INT(size) map.reserve(size)
...
#define SETUP_STR str_map_t str_map
#define RESERVE_STR(size) str_map.reserve(size)
